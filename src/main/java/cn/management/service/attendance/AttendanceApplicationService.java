...
public interface AttendanceApplicationService extends BaseService<AttendanceApplicationMapper, AttendanceApplication> {
	 ...
	 * @throws SysException 
	 */
	AttendanceApplication doAdd(AttendanceApplication attendanceApplication) throws SysException;
	 ...
	 * @return
	 */
	boolean doAudit(AttendanceApplication attendanceApplication, String identity);
