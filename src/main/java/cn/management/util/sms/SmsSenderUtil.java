...
import cn.management.util.sms.SmsMultiSenderResult.Detail;

/**
 * 短信发送相关工具类，来自腾讯云短信接口示例
 * @author ZhouJiaKai
 * @date 2018-03-06
 */
class SmsSenderUtil {
    ...
    public String calculateSig(String appkey, long random, String msg, long curTime,
    ...
    public String calculateSigForTempl(String appkey, long random, long curTime,
        ArrayList<String> phoneNumbers) throws NoSuchAlgorithmException {
        String phoneNumbersString = phoneNumbers.get(0);
        for (int i = 1; i < phoneNumbers.size(); i++) {
            phoneNumbersString += "," + phoneNumbers.get(i);
